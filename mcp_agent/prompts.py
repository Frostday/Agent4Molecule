...
- If the user asks for validating the output from enzygen, first complete the pipeline and then use gromacs copilot for md and docking pipeline for docking.
