...
HEME_BINDER_PATH = "/ocean/projects/cis240137p/ksubram4/Agent4Molecule/heme_binder_diffusion/"
CONDAPATH = "/ocean/projects/cis240137p/ksubram4/anaconda3"
diffusion_script = os.path.join("/ocean/projects/cis240137p/ksubram4/Agent4Molecule/rf_diffusion_all_atom/run_inference.py")
import sys
...
PARAMS_GENERATION = "/ocean/projects/cis240137p/ksubram4/Agent4Molecule/rosetta.source.release-408/main/source/scripts/python/public/molfile_to_params.py"
combine_protein_ligand_file = "/ocean/projects/cis240137p/ksubram4/Agent4Molecule/mcp_agent/util/combine_protein_ligand.py"
separate_protein_ligand_file = "//ocean/projects/cis240137p/ksubram4/Agent4Molecule/mcp_agent/util/sep_protein_ligand.py"
...
def separate_ligand_protein_pdb(
    ...
    answer_dict['answer'] = f"Protein pdb file generated at: {INPUT_DIR}/protein.pdb\nLigand sdf file generated at: {INPUT_DIR}/ligand.sdf"
    answer_dict['visualize'] = 'molecule'
    answer_dict['message_render'] = 'text'
    answer_dict['file_path'] =  f"{INPUT_DIR}/protein.pdb"
    # return f"Protein pdb file generated at: {INPUT_DIR}/protein.pdb\nLigand sdf file generated at: {INPUT_DIR}/ligand.sdf"
    return answer_dict
...
def convert_ligand_pdb_to_sdf(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] = f"Ligand sdf file generated at: {INPUT_DIR}/ligand.sdf"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{INPUT_DIR}/ligand.sdf"
    return answer_dict
...
def generate_cst_file(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] = f"CST file generated at: {INPUT_DIR}/cst_file.cst"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{INPUT_DIR}/cst_file.cst"
    return answer_dict
...
def generate_ligand_params_file(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] = f"Ligand params file generated at: {INPUT_DIR}/{ligand}.params"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{INPUT_DIR}/{ligand}.params"
    return answer_dict
...
def run_rf_diffusion(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] = f"RFDiffusionAA Job Completed\nAll output files: {diffusion_output_files}\n\n" + "Log File:\n\n----------\n" + logs + "\n----------\n\nError File:\n\n----------\n" + errors + "\n----------\n"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{diffusion_output_files}"
    return answer_dict
...
def run_protein_mpnn(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] =  f"ProteinMPNN Job Completed\nAll output files: {protein_seq_fasta_files}\n\nLog File:\n\n----------\n" + logs + "\n----------\n\nError File:\n\n----------\n" + errors + "\n----------\n\nMasked positions JSONL file creation logs:\n\n----------\n" + json_creation_logs + "\n----------\n\nMasked positions JSONL file creation errors:\n\n----------\n" + json_creation_errors + "\n----------\n"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{protein_seq_fasta_files}"
    return answer_dict
...
def run_af2(
    ...
    # return f"AF2 Job Completed\nAll output files: {af2_out_files}\n\n----------\n" + "\n----------\n----------\n".join(structures) + f"\n----------\n\nAF2 Scores CSVs: {af2_csv_files}\nExample:\n\n----------\n" + af2_scores_csv + "\n----------\n\nLog File:\n\n----------\n" + logs + "\n----------\n\nError File:\n\n----------\n" + errors + "\n----------\n"
    answer_dict = {'status':'successful'}
    answer_dict['answer'] =  f"AF2 Job Completed\nAll output files: {af2_out_files}\n\nAF2 Scores CSVs: {af2_csv_files}\n\n----------\n" + af2_scores_csv + "\n----------\n\nLog File:\n\n----------\n" + logs + "\n----------\n\nError File:\n\n----------\n" + errors + "\n----------\n"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{af2_out_files}"
    return answer_dict
...
def analyze_af2_outputs(
    ...
    if len(scores_af2_filtered) > 0:
        ...
        answer_dict = {'status':'error'}
        answer_dict['answer'] = f"Error: No good models to continue this pipeline with\n\nCSV File:\n\n----------\n{scores_af2.to_csv(index=False)}\n----------\n\nLogs:\n\n----------\n" + logs + "\n----------\n\nErrors:\n\n----------\n" + errors + "\n----------\n"
        answer_dict['visualize'] = "none"
        answer_dict['message_render'] = "text"
        answer_dict['file_path'] = ""
        return answer_dict
    ...
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{good_af2_models}"
    return answer_dict
...
def run_ligand_mpnn(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] =  (
    f"LigandMPNN Job Completed\n"
    f"All output files: {pdb_files}\n"
    f"Scores File: {os.path.join(DESIGN_DIR_ligMPNN, 'scorefile.txt')}\n"
    "\n----------\n"
    + scores.to_csv(index=False)
    + "\n----------\n\n"
    f"Log File:\n\n----------\n{logs}\n----------\n\n"
    ...
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{pdb_files}"
    return answer_dict
...
def analyze_ligand_mpnn_outputs(
    ...
    if len(filtered_scores) > 0:
        ...
        answer_dict = {'status':'successful'}
        answer_dict['answer'] = "Error: No good designs created, change the filtering criteria or rerun the previous jobs with better parameters\n\nScores File:\n\n----------\n" + scores.to_csv(index=False) + "\n----------\n"
        answer_dict['visualize'] = "none" 
        answer_dict['message_render'] = "text"
        answer_dict['file_path'] = ""
        return answer_dict
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] =  f"Ligand MPNN Designs Filtered\nNumber of good structure(s): {len(filtered_scores)}\nAll output files: {ligmpnn_good_files}\n\nFiltered Score File:\n\n----------\n{filtered_scores.to_csv(index=False)}\n----------\n"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{ligmpnn_good_files}"
    return answer_dict
...
def run_ligand_mpnn_redesign_2nd_layer_residues(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] =  f"LigandMPNN Job Completed\nAll output files: {protein_seq_fasta_files}\n\nLog File:\n\n----------\n" + logs + "\n----------\n\nError File:\n\n----------\n" + errors + "\n----------\n\nJSON File (designable positions) Creation Logs:\n\n----------\n" + json_file_creation_logs + "\n----------\n\nJSON File (designable positions) Creation Errors:\n\n----------\n" + json_file_creation_errors + "\n----------\n"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{protein_seq_fasta_files}"
    return answer_dict
...
def run_fast_relax(
    ...
    if os.path.exists("scorefile.txt"):
        ...
        answer_dict['visualize'] = "none"
        answer_dict['message_render'] = "text"
        answer_dict['answer'] = "Fast Relax job ran into an error\n\nLog File:\n\n----------\n" + logs + "\n----------\n\nError File:\n\n----------\n" + errors + "\n----------\n"
        return answer_dict
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] =  (
    f"Fast Relax Job Completed\n"
    f"All output files: {pdb_files}\n"
    f"Scores File: {os.path.join(RELAX_DIR, 'scorefile.txt')}\n\n----------\n"
    + scores.to_csv(index=False)
    + "\n----------\n\nLog File:\n\n----------\n"
    + logs
    + "\n----------\n\nError File:\n\n----------\n"
...
def analyze_fast_relax_outputs(
    ...
    answer_dict = {'status':'successful'}
    answer_dict['answer'] =  (
    f"Fast Relax Designs Filtered\n"
    f"Number of good structure(s): {len(filtered_scores)}\n"
    f"All output files: {glob.glob(f'{RELAX_DIR}/good/*.pdb')}\n\n"
    f"Scores Distribution Plot: {img_path}\n\n"
    f"Filtered Score File:\n\n----------\n"
    f"{filtered_scores.to_csv(index=False)}\n"
    "----------\n"
)
    answer_dict['message_render'] = "text"
    answer_dict['visualize'] = "none"
    answer_dict['message_render'] = "text"
    answer_dict['file_path'] = f"{RELAX_DIR}/good/*.pdb"
    return answer_dict
